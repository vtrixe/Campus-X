...
const roleIconMap = {
    "STUDENT" : null,
  "LECTURER": <Notebook className="h-4 w-4 ml-2 text-indigo-500" />,
  "ADMIN": <FcManager className="h-4 w-4 text-rose-500" />
}
        ...
        <ScrollArea className="mt-8 max-h-[420px] pr-6">
          {server?.members?.map((member) => (
            <div key={member.id} className="flex items-center gap-x-2 mb-6">
              <UserAvatar src={ member.user.image ||"defaultImageUrl"} />
              ...
              {server.adminId !== member.userId && loadingId !== member.id && (
                      ...
                      <DropdownMenuSub>
                        ...
                        <DropdownMenuPortal>
                          <DropdownMenuSubContent>
                            ...
                            <DropdownMenuItem
                              onClick={() => onRoleChange(member.id, "LECTURER")}
                            >
